...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Jun 2025 pada 04.19
...
(31, 998877, 'JARJIT', '1749173441_codeh.png');
...
INSERT INTO `rental` (`rental_id`, `kendaraan_id`, `pelanggan_id`, `tgl_rental`, `tgl_kembali`, `total`) VALUES
(31, 14, 31, '2025-06-06', '2025-06-07', 2000000);
...
--
ALTER TABLE `kendaraan`
  MODIFY `kendaraan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT untuk tabel `pelanggan`
--
ALTER TABLE `pelanggan`
  MODIFY `pelanggan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
